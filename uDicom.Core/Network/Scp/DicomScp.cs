...
namespace UIH.Dicom.Network.Scp
{
    ...
    /// <remarks>
    /// <para>
    /// This class uses the UIH.Dicom assembly to implement a DICOM SCP.  
    ...
    public class DicomScp<TContext>
    {
        ...
        public bool Start()
        {
            ...
            LogAdapter.Logger.Error("Attempted to listen on AE {0} with no Listening IP Address set.", AeTitle);
