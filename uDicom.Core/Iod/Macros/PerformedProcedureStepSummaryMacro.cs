...
using UIH.Dicom.Iod.Macros.PerformedProcedureStepSummary.PerformedProtocolCodeSequence;
using UIH.Dicom.Utilities;

namespace UIH.Dicom.Iod.Macros
{
	/// <summary>
	...
	internal class PerformedProcedureStepSummaryMacro : IodBase, IPerformedProcedureStepSummaryMacro
	{
		...
		/// <summary>
		/// Gets an enumeration of <see cref="DicomTag"/>s used by this macro.
		/// </summary>
