...
namespace uDicom.Core.Converter
{
    ...
    public class XmlDicomConverter : IXmlDicomConverter
    {
        ...
        private void ConvertChildren(DicomDataset ds, XmlWriter writer)
        {
        ...
        private static void ConvertValue(DicomElement element, XmlWriter writer)
        {
            DicomVr dicomVr = element.Tag.VR;
        ...
        private void ConvertSequence(DicomElement element, XmlWriter writer)
        {
            for (int index = 0; index < element.Count; index++)
            {
